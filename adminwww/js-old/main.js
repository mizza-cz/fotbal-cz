$(function () {
	...
	var createColorBox = function (color, name, after) {
		var box = " <div style='width: 16px; height: 16px; display: inline-block; vertical-align: -4px; \
					border: 1px solid black; background-color: " + color + "'></div>";
...
//	$('#content a.opencloseBlock').click(function () {
//		var self = $(this);
//		var target = self.next('#content div.openableBlock');
//
//		if (self.hasClass('closed')) {
//			target.slideDown();
//			self.text(hideDetailTranslate);
//		} else {
//			target.slideUp();
//			self.text(showDetailTranslate);
//		}
//
...
//	};
//
//	$('#addAlternativeName').click(createReplaceFunction());
//
//	$('#addClubName').click(createReplaceFunction(function (html) {
...
//
//	$('#content .clubSelect').change(function () {
//		var self = $(this);
...
//
	if (typeof playerWhisperByName !== 'undefined' && typeof playerWhisperById !== 'undefined') {
		$("#content .playerMultiSelect").select2({
			minimumInputLength: 3,
			tags: [],
			dropdownAutoWidth: true,
			ajax: {
				url: playerWhisperByName,
				dataType: 'json',
				type: "GET",
				quietMillis: 20,
				data: function (term) {
...
//
//	if (typeof folderWhisperByName !== 'undefined' && typeof folderWhisperById !== 'undefined') {
//		$("#content .folderSelect").select2({
//			minimumInputLength: 3,
//			dropdownAutoWidth: true,
//			ajax: {
//				url: folderWhisperByName,
//				dataType: 'json',
//				type: "GET",
//				quietMillis: 20,
//				data: function (term) {
...
//	});
//
//	$('#deleteMainPhoto').click(function () {
