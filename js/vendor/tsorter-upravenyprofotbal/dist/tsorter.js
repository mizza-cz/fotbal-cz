...
var tsorter = (function()
{
    ...
    sorterPrototype = {
        ...
        {   
            ...
            if (typeof(th.getAttribute('data-tsorter')) !== 'string') { return false; }
            ...
            if( that.prevCol === that.column )
            {
                ...
                if(th.className.indexOf('descend') === -1) {
            ...
            else
            {
                ...
                if( that.prevCol !== -1 && that.ths[that.prevCol].className !== 'exc_cell'){
                    prevColClass = that.ths[that.prevCol].className;
                    prevColClass = prevColClass.replace('descend', '').replace('ascend', '');
                    that.ths[that.prevCol].className = prevColClass;
                }
