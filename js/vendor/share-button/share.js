...
Share = (function(superClass) {
  ...
  Share.prototype.network_twitter = function() {
    return this.popup('https://twitter.com/intent/tweet', {
      text: encodeURIComponent(this.config.twTitle),
  ...
  Share.prototype.inject_html = function(instance) {
    return instance.innerHTML = "<label><span><i class='icon-external'></i>" + this.config.ui.button_text + "</span></label><div class='social load " + this.config.ui.flyout + "'><ul><li class='icon-pinterest' data-network='pinterest'></li><li class='icon-twitter' data-network='twitter'></li><li class='icon-facebook' data-network='facebook'></li><li class='icon-gplus' data-network='google_plus'></li><li class='entypo-paper-plane' data-network='email'></li></ul></div>";
  };
  ...
  Share.prototype.default_tw_title = function() {
    var content;
    if (content = document.querySelector('meta[name="twitter:title"]')) {
      return content.getAttribute('content');
    } else if (content = document.querySelector('title')) {
      return content.innerText;
    }
